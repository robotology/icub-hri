...
#ifndef __ICUBHRI_AGENT_H__
#define __ICUBHRI_AGENT_H__
...
struct Body
{
    ...
    Body()
    {
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_HEAD].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_SHOULDER_C].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_SHOULDER_L].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_SHOULDER_R].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_SPINE].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_HAND_R].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_HAND_L].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_ELBOW_R].resize(3,0.0);
        m_parts[ICUBHRI_OPC_BODY_PART_TYPE_ELBOW_L].resize(3,0.0);
        //m_parts[ICUBHRI_OPC_BODY_PART_TYPE_LEFT_HIP].resize(3,0.0);
        //m_parts[ICUBHRI_OPC_BODY_PART_TYPE_LEFT_KNEE].resize(3,0.0);
        //m_parts[ICUBHRI_OPC_BODY_PART_TYPE_LEFT_FOOT].resize(3,0.0);
        //m_parts[ICUBHRI_OPC_BODY_PART_TYPE_RIGHT_HIP].resize(3,0.0);
        //m_parts[ICUBHRI_OPC_BODY_PART_TYPE_RIGHT_KNEE].resize(3,0.0);
        //m_parts[ICUBHRI_OPC_BODY_PART_TYPE_RIGHT_FOOT].resize(3,0.0);
    }
...
public:
    ...
    {
        if (_entityType == ICUBHRI_OPC_ENTITY_AGENT)
            return true;
        else
