...
{
    m_entity_type = ICUBHRI_OPC_ENTITY_OBJECT;
...
Bottle Object::asBottle() const
{
    ...
    //Position
    bSub.addString(ICUBHRI_OPC_OBJECT_ROBOTPOSX_TAG);
    bSub.addDouble(m_ego_position[0]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_ROBOTPOSY_TAG);
    bSub.addDouble(m_ego_position[1]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_ROBOTPOSZ_TAG);
    bSub.addDouble(m_ego_position[2]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_ROBOTPOS_TAG);
    ...
    //Orientation
    bSub.addString(ICUBHRI_OPC_OBJECT_ROBOTORX_TAG);
    bSub.addDouble(m_ego_orientation[0]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_ROBOTORY_TAG);
    bSub.addDouble(m_ego_orientation[1]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_ROBOTORZ_TAG);
    bSub.addDouble(m_ego_orientation[2]);
    b.addList() = bSub;
    bSub.clear();

    //Dimension
    bSub.addString(ICUBHRI_OPC_OBJECT_RTDIMX_TAG);
    bSub.addDouble(m_dimensions[0]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_RTDIMY_TAG);
    bSub.addDouble(m_dimensions[1]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_RTDIMZ_TAG);
    bSub.addDouble(m_dimensions[2]);
    b.addList() = bSub;
    bSub.clear();

    //Color
    bSub.addString(ICUBHRI_OPC_OBJECT_GUI_COLOR_R);
    bSub.addDouble(m_color[0]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_GUI_COLOR_G);
    bSub.addDouble(m_color[1]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_GUI_COLOR_B);
    bSub.addDouble(m_color[2]);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_SALIENCY);
    bSub.addDouble(m_saliency);
    b.addList() = bSub;
    bSub.clear();
    bSub.addString(ICUBHRI_OPC_OBJECT_VALUE);
    bSub.addDouble(m_value);
    b.addList() = bSub;
    bSub.clear();

    //Present
    bSub.addString(ICUBHRI_OPC_OBJECT_PRESENT_TAG);
...
bool Object::fromBottle(const Bottle &b)
{
    ...
    if (!b.check(ICUBHRI_OPC_OBJECT_ROBOTPOSX_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_ROBOTPOSY_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_ROBOTPOSZ_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_RTDIMX_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_RTDIMY_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_RTDIMZ_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_ROBOTORX_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_ROBOTORY_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_ROBOTORZ_TAG) ||
        !b.check(ICUBHRI_OPC_OBJECT_GUI_COLOR_R) ||
        !b.check(ICUBHRI_OPC_OBJECT_GUI_COLOR_G) ||
        !b.check(ICUBHRI_OPC_OBJECT_GUI_COLOR_B) ||
        !b.check(ICUBHRI_OPC_OBJECT_PRESENT_TAG) ||
        !b.check("object_area")               ||
        !b.check(ICUBHRI_OPC_OBJECT_VALUE))
    {
        return false;
    }

    m_ego_position[0] = b.find(ICUBHRI_OPC_OBJECT_ROBOTPOSX_TAG).asDouble();
    m_ego_position[1] = b.find(ICUBHRI_OPC_OBJECT_ROBOTPOSY_TAG).asDouble();
    m_ego_position[2] = b.find(ICUBHRI_OPC_OBJECT_ROBOTPOSZ_TAG).asDouble();
    m_dimensions[0] = b.find(ICUBHRI_OPC_OBJECT_RTDIMX_TAG).asDouble();
    m_dimensions[1] = b.find(ICUBHRI_OPC_OBJECT_RTDIMY_TAG).asDouble();
    m_dimensions[2] = b.find(ICUBHRI_OPC_OBJECT_RTDIMZ_TAG).asDouble();
    m_ego_orientation[0] = b.find(ICUBHRI_OPC_OBJECT_ROBOTORX_TAG).asDouble();
    m_ego_orientation[1] = b.find(ICUBHRI_OPC_OBJECT_ROBOTORY_TAG).asDouble();
    m_ego_orientation[2] = b.find(ICUBHRI_OPC_OBJECT_ROBOTORZ_TAG).asDouble();
    m_color[0] = b.find(ICUBHRI_OPC_OBJECT_GUI_COLOR_R).asDouble();
    m_color[1] = b.find(ICUBHRI_OPC_OBJECT_GUI_COLOR_G).asDouble();
    m_color[2] = b.find(ICUBHRI_OPC_OBJECT_GUI_COLOR_B).asDouble();
    m_saliency = b.find(ICUBHRI_OPC_OBJECT_SALIENCY).asDouble();
    m_value = b.find(ICUBHRI_OPC_OBJECT_VALUE).asDouble();
    m_present = b.find(ICUBHRI_OPC_OBJECT_PRESENT_TAG).asDouble();
