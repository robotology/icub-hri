...
/************************************************************************/
yarp::os::Bottle icubhri::opcGetIdsFromAsk(const yarp::os::Bottle &reply)
{
    Bottle ids;
    if (reply.size()>0)
...
/************************************************************************/
void icubhri::replace_all(std::string & in, const std::string & plain, const std::string & tok)
{
...
/************************************************************************/
std::string icubhri::grammarToString(const std::string &sPath)
{
    std::string sOutput = "";
