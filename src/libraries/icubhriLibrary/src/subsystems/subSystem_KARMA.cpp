...
void icubhri::SubSystem_KARMA::appendTarget(yarp::os::Bottle &b, const yarp::sig::Vector &t)
{
...
void icubhri::SubSystem_KARMA::appendDouble(yarp::os::Bottle &b, const double &v)
{
    yarp::os::Bottle &sub=b;
    sub.addDouble(v);
}

void icubhri::SubSystem_KARMA::selectHandCorrectTarget(yarp::os::Bottle &options, const std::string &targetName,
...
bool icubhri::SubSystem_KARMA::sendCmd(yarp::os::Bottle &cmd)
{
    bool ret=false;
...
bool icubhri::SubSystem_KARMA::connect()
{
...
icubhri::SubSystem_KARMA::SubSystem_KARMA(const std::string &masterName, const std::string &robot) : SubSystem(masterName)
{
...
void icubhri::SubSystem_KARMA::Close()
{
    portStop.interrupt();
    portRPC.interrupt();
...
yarp::sig::Vector icubhri::SubSystem_KARMA::applySafetyMargins(const yarp::sig::Vector &in)
{
...
bool icubhri::SubSystem_KARMA::returnArmSafely(std::string armType)
{
...
bool icubhri::SubSystem_KARMA::chooseArm(const std::string &armType)
{
...
void icubhri::SubSystem_KARMA::chooseArmAuto()
{
    yarp::os::Bottle bCmd;
    bCmd.addVocab(yarp::os::Vocab::encode("tool"));
...
bool icubhri::SubSystem_KARMA::pushAside(const std::string &objName,
...
bool icubhri::SubSystem_KARMA::pushFront(const std::string &objName,
...
bool icubhri::SubSystem_KARMA::push(const yarp::sig::Vector &targetCenter,
...
bool icubhri::SubSystem_KARMA::pullBack(const std::string &objName,
...
bool icubhri::SubSystem_KARMA::draw(const yarp::sig::Vector &targetCenter,
                                       const double theta, const double radius,
...
bool icubhri::SubSystem_KARMA::vdraw(const std::string &objName,
...
bool icubhri::SubSystem_KARMA::openCartesianClient()
{
...
icubhri::SubSystem_KARMA::~SubSystem_KARMA()
{
    SubARE->Close();
    delete SubARE;
    driverL.close();
