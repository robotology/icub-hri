...
void icubhri::SubSystem_ARE::appendCartesianTarget(yarp::os::Bottle &b, const yarp::sig::Vector &t)
{
...
void icubhri::SubSystem_ARE::selectHandCorrectTarget(yarp::os::Bottle &options, yarp::sig::Vector &target, const std::string& objName, const std::string handToUse)
{
    std::string hand="";
...
bool icubhri::SubSystem_ARE::sendCmd(const yarp::os::Bottle &cmd)
{
    bool ret=false;
...
bool icubhri::SubSystem_ARE::connect()
{
...
icubhri::SubSystem_ARE::SubSystem_ARE(const std::string &masterName) : SubSystem(masterName)
{
...
void icubhri::SubSystem_ARE::Close()
{
    opc->interrupt();
    opc->close();
...
bool icubhri::SubSystem_ARE::getTableHeight(double &height)
{
...
yarp::sig::Vector icubhri::SubSystem_ARE::applySafetyMargins(const yarp::sig::Vector &in)
{
...
bool icubhri::SubSystem_ARE::home(const std::string &part)
{
...
bool icubhri::SubSystem_ARE::take(const std::string &sName, const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::push(const std::string &sName, const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::point(const yarp::sig::Vector &targetUnsafe, const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::drop(const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::dropOn(const yarp::sig::Vector &targetUnsafe, const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::observe(const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::expect(const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::give(const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::waving(const bool sw)
{
...
bool icubhri::SubSystem_ARE::look(const yarp::sig::Vector &target, const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::track(const yarp::sig::Vector &target, const yarp::os::Bottle &options)
{
...
bool icubhri::SubSystem_ARE::impedance(const bool sw)
{
    yarp::os::Bottle bCmd;
...
bool icubhri::SubSystem_ARE::setExecTime(const double execTime)
{
    yarp::os::Bottle bCmd;
...
icubhri::SubSystem_ARE::~SubSystem_ARE()
{
    delete opc;
}
