...
icubclient::SubSystem_IOL2OPC::SubSystem_IOL2OPC(const std::string &masterName) : SubSystem(masterName) {
...
bool icubclient::SubSystem_IOL2OPC::changeName(const std::string &old_name, const std::string &new_name) {
